	...
	<nav class="navbar navbar-inverse navbar-fixed-top">
		<div class="container">
			<div class="navbar-header">
				...
				<h1 style="color: #272267;" id="myhead">iLearn</h1>
			</div>
			...
			<section class="slider text-center" id="slider">
				<div class="modal-dialog ">
					...
					<div class="modal-body" >
						...
						<form method="POST" action="validation.php" onsubmit="return validation()">
							<div class="form-group">
								<label><i class="fa fa-user fa-1x"></i> Username :</label>
					...
					<div class="right-box">
						...
						<a href="https://accounts.google.com/signin/v2/identifier?hl=en&continue=https%3A%2F%2Fwww.google.com%3Fhl%3Den-US&ec=GAlA8wE&flowName=GlifWebSignIn&flowEntry=AddSession"><button class="social google">Log in with Gmail</button></a>
					</div>
