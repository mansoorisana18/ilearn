...
.div1                           /* for title image*/
{
    ...
    height: 500px;
    width: 1263px;
    background: url(./uploadimg/programming_img.png) !important; 
}
	...
	<nav class="navbar navbar-inverse navbar-fixed-top">
		<div class="container">
			<div class="navbar-header">
				...
				<h1 style="color: white;margin-top: 10px;" id="myhead">iLearn</h1>
			</div>
			<div class="collapse navbar-collapse" id="navi">
                 <!------Navigation menus starts---->
				<ul class="nav navbar-nav navbar-right">
					<li> <a href="index.php">Home</a></li>
					<li> <a href="#latest">Our Service</a></li>
			...
			<div class="col-md-4 col-sm-6 col-xs-12 content-border" style="margin-bottom: 10px;">
 								<div class="latest-news-wrap">
 									...
 									<div class="news-content">
 										...
 										<a href="programming/java/java_programming.php?course_name=<?php echo $res['language_name'] ?>">Start Tutorial...</a>
 									</div>
 								</div>
 							</div>
...
<footer class="section footer-classic context-dark bg-image" style="background: #272267;" id="cont">
        <div class="container">
          <div class="row row-30">
            <div class="col-md-4 col-xl-5">
              <div class="pr-xl-4"><br><a class="brand" href="index.html"></a>
                <p>iLearn is an excellent learning hub, dedicated to the programmer who want to explore.</p>
                <!-- Rights-->
                <p class="rights"><span>©  </span><span class="copyright-year">2018</span><span> </span><span>iLearn</span><span>. </span><span>All Rights Reserved.</span></p>
              </div>
            </div>
            <div class="col-md-4">
              <h5>Contacts</h5>
              <dl class="contact-list">
                <dt>Address:</dt>
                <dd>SV Road, Andheri West, Mumbai 400053</dd>
              </dl>
              <dl class="contact-list">
                <dt>Email:</dt>
                <dd><a href="mailto:#">ilearn@gmail.com</a></dd>
              </dl>
              <dl class="contact-list">
                <dt>Mobile No.:</dt>
                <dd><a href="tel:#">+91 9082944167</a> <span>or</span> <a href="tel:#">+91 7738364876</a>
                </dd>
              </dl>
            </div>
