	...
	<nav class="navbar navbar-inverse navbar-fixed-top">
		<div class="container">
			<div class="navbar-header">
				...
				<h1 style="color: white;" id="myhead">iLearn</h1>
			</div>
			...
			<div class="indexpg" style="width: 100%; height: 100vh; margin-top: 80px;
	background-size: 100vh !important; background-position: center">
				<img src="./img/ppindex.png" alt="" width=100% height=85%>
			</div>
         	...
         	<div class="row">
         		<div class="col-xs-12">
         			<div class="section-title text-center">
         				<h2><b>SERVICES</b></h2>
         				<p>
         					We provide services provided such as programming tutorials, video tutorials and quizzes. <br>Choose one and start your iLearn journey!
         				</p>
         			</div>
         		</div>
         	</div>
         	<div class="row">
         		<div class="col-md-4 col-sm-6 col-xs-12">
         			<div class="service-wrap text-center">
         				...
         				<p>
         					Here you will find the lecture tutorials related to programming languages 
         		...
         		<div class="col-md-4 col-sm-6 col-xs-12">
         			<div class="service-wrap text-center">
         				...
         				<p>
         					Here you will find the videos tutorials related to programming languages 
         					like JAVA, PYTHON, ANDROID etc.
         				</p>
         			</div>
         		</div>
         		...
         		<div class="col-md-4 col-sm-6 col-xs-12">
         			<div class="service-wrap text-center">
         				...
         				<p>
         					Here you will find quizzes to assess your acquired knowledge & improve your coding skill
         				</p>
         			</div>
         		</div>
<!-- 
 ...
 -->
			...
			<section class="work" id="work"><br>
				...
				<p class="text-center">Take one of iLearn’s range of Programming courses and learn how to code using the most incredibly useful languages.</p>
					...
					<div class="row">
						<div class="col-md-12 text-center">
							...
							<div class="sub-heading">
								<p>
									Some general queries to help us serve you better <br>Hope this helps. Happy Learning!
								</p>
							...
							<?php } ?>
								...
								<div class="panel panel-default">
									<div class="panel-heading" id="headingTwo">
										<h4 class="panel-title">
											<a href="#collapseTwo" class="collapsed" data-toggle="collapse" data-parent="#accordian">What is the webiste about?</a>
										</h4>
									</div>
									<div id="collapseTwo" class="panel-collapse collapse" aria-labelledby="headingTwo">
										<div class="panel-body">
											<p>
												iLearn is an online E-learning website. <br>
												Here you can learn programming languages, enhance your problem solving & coding skill.	
											</p>
										</div>
									</div>
								</div>
